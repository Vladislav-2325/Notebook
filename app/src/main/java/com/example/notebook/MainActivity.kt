...
class MainActivity : AppCompatActivity() {
    ...
    //эта хуйня чтобы забрать результат из второй активности заметок, с ней я наебался пиздец, но не так как с адаптером
    ...
    //эта хуйня чтобы обработать обычные нажатия как модификацию записки
    ...
    //эта хуйня чтобы обработать долгие нажатия как удаление записки
